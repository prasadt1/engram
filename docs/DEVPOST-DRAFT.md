...
- [ ] candidates to watch for: Qwen-VL critique-quality parity with Gemini · re-implementing Coach's grounding corpus without Google Agent Builder · MCP registration path (Responses API vs Qwen-Agent)
